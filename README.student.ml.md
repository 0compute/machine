...
```mermaid
graph TD
    A[ഹ്യൂമൻ സോഴ്സ് കോഡ്] -->|1. ഉറവിടം| B[മെഷീൻ ലിംഗുവ ഫ്രാങ്ക ഐആർ 1.0]
    B -->|2. ട്രാൻസ്പൈലേഷൻ| C(ടാർഗെറ്റ് ഔട്ട്പുട്ട്)
    C -.->|കോഗ്നിറ്റീവ് ലോഡ്: സിസ്റ്റം ഹീറ്റായി നിരീക്ഷിക്കപ്പെടുന്നു. ഓവർലോഡ് തെർമൽ ത്രോട്ടിംഗിനെ ട്രിഗർ ചെയ്യുന്നു.| G[വൈബ് ലെയർ]
    G -->|കാലിബ്രേഷൻ| B
    B -->|IRQ അഭ്യർത്ഥന| H[ഹാർഡ്‌വെയർ തടസ്സങ്ങൾ]
    H -->|ഗ്ലോബൽ കിൽ| B
    B == സ്ഥിരീകരിക്കുക ==> I{ടോർവാൾഡ്സ് ചെക്ക്സം}
```
