...
```mermaid
graph TD
    A[मानवी स्त्रोत कोड] -->|1. स्त्रोत| B[मशीन Lingua Franca IR 1.0]
    B -->|2. ट्रान्सपिलेशन| C(लक्ष्य आउटपुट)
    C -.->|संज्ञानात्मक भार: सिस्टम हीट म्हणून निरीक्षण केले जाते. ओव्हरलोड थर्मल थ्रॉटलिंग ट्रिगर करते.| G[Vibe स्तर]
    G -->|कॅलिब्रेशन| B
