...
```mermaid
graph TD
    A[হিউম্যান সোর্স কোড] -->|1. উৎস| B[মেশিন Lingua Franca IR 1.0]
    B -->|2. ট্রান্সপিলেশন| C(টার্গেট আউটপুট)
    C -.->|জ্ঞানীয় লোড: সিস্টেম হিট হিসাবে পর্যবেক্ষণ করা হয়। ওভারলোড থার্মাল থ্রটলিং ট্রিগার করে।| G[ভাইব লেয়ার]
    G -->|ক্রমাঙ্কন| B
    B -->|IRQ অনুরোধ| H[হার্ডওয়্যার বাধা]
    H -->|গ্লোবাল কিল| B
    B == যাচাই করুন ==> I{টরভাল্ডস চেকসাম}
```
