...
```mermaid
graph TD
    A[ಮಾನವ ಮೂಲ ಕೋಡ್] -->|1. ಮೂಲ| B[ಟ್ರಾನ್ಸ್ಪೈಲ್]
    B -->|2. ಟಾರ್ಗೆಟ್ ಔಟ್ಪುಟ್| C(ವೈಬ್ ಲೇಯರ್)
    C -.->|ಕಾಗ್ನಿಟಿವ್ ಲೋಡ್: ಸಿಸ್ಟಮ್ ಹೀಟ್ ಆಗಿ ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡಲಾಗುತ್ತದೆ. ಓವರ್ಲೋಡ್ ಥರ್ಮಲ್ ಥ್ರೊಟ್ಲಿಂಗ್ ಅನ್ನು ಪ್ರಚೋದಿಸುತ್ತದೆ.| G[ಮಾಪನಾಂಕ ನಿರ್ಣಯ]
    G -->|ಯಂತ್ರಾಂಶ ಅಡಚಣೆಗಳು| B
    B -->|ಗ್ಲೋಬಲ್ ಕಿಲ್| H[ಗ್ಲೋಬಲ್ ಕಿಲ್]
    H -->|ಟೊರ್ವಾಲ್ಡ್ಸ್ ಚೆಕ್ಸಮ್| B
    B == ಪರಿಶೀಲಿಸಿ ==> I{ಕಟ್ಟುನಿಟ್ಟಿನ ನಿರ್ಬಂಧಗಳು}
```
