...
* **Why:** Tvetydighet är uppsåtets fiende. Lossless säkerställer 1:1 paritet mellan källa och mål.
...
- **Paritetskontroll: Strikt krav på att Metadata (Vibe) matchar nyttolast (Words).
  * **Why:** Sarkasm är ett paritetsfel. Om vibben inte stämmer överens med orden är anslutningen osäker.**
