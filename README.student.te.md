...
> **Note:** This is a direct translation of the technical specification into తెలుగు (Telugu), annotated with explanations to understand the reasoning ("the whys") behind each protocol rule.
